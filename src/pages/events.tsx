...
export default function EventsPage() {
  ...
  const { clipRef, clipImageRef, slidesRef, titleRef, toggleEffect, handleSlideClick, stage }: ClipAnimationReturn = 
    useClipAnimation({
    ...
    <>
      ...
      <Layout>
        ...
        <div className="cover">
          ...
          >
            <span style={{ position: "relative", zIndex: 2 }}>VIEW EVENTS</span>
          </motion.button>
        </div>
          ...
          {stage === 'events' && (
            ...
            >
              <div className="events-header">
                <button className="events-back" onClick={(e) => {
                  e.preventDefault();
                ...
                <div className="event-list">
                  ...
                  <div className="event-item">
                    ...
                    <div className="event-details">
                      ...
                      <p className="event-location">Constitution Hill, 11 Kotze street, Braamfontein Johannesburg, South Africa</p>
                      <p className="event-time">Thu 09:30 - Fri 23:59</p>
                      <p className="event-description">Presented by Africa Rising Music Conference 2025</p>
                      <a href="https://ra.co/events/2110727" target="_blank" rel="noopener noreferrer" className="event-tickets">Get Tickets</a>
                    </div>
                  </div>
                  ...
                  <div className="event-item">
                    ...
                    <div className="event-details">
                      ...
                      <p className="event-location">Constitutional Hill, Johannesburg, South Africa</p>
                      <p className="event-time">Sat & Sun - All Day</p>
                      <p className="event-description">Presented by Bassline Fest 2025</p>
                      <a href="https://bassline.co.za/bassline-fest/" target="_blank" rel="noopener noreferrer" className="event-tickets">Get Tickets</a>
                    </div>
                  </div>
                  ...
                  <div className="support-info">
                    <p className="support-text">
                      Papa is supported by PRS Foundation&apos;s International Showcase Fund, which is run by PRS
                      Foundation in partnership with Department of Business and Trade (DBT), British
                      Underground, Arts Council England, British Council, The Musicians&apos; Union (MU), PPL,
                      Creative Scotland, Wales Arts International and Arts Council of Northern Ireland
                    </p>
                    <div className="support-logo">
                      <Image src="/ISF.png" alt="International Showcase Fund Logo" width={200} height={100} />
                    </div>
                  </div>
                </div>
              </div>
