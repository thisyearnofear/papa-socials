...
export function useClipAnimation(options: ClipAnimationOptions = {}): ClipAnimationReturn {
  ...
  }, [isAnimating, stage, initialStage, stages, callbacks, clipRef, clipImageRef, slidesRef, titleRef, animationOptions]);
  ...
  const toggleEffect = useCallback((customOptions: CustomAnimationOptions = {}) => {
    ...
    } else if (stage === stages[1]) { // Grid stage
      // Grid to initial animation
      showPreview(customOptions);
    } else if (stage === stages[2]) { // Content stage
  ...
  }, [isAnimating, stage, initialStage, stages, callbacks, showSlider, showPreview, slidesRef, titleRef, animationOptions]);
